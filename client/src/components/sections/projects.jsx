              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                >
                  ...
                  <div className="bg-gradient-to-br from-portfolio-accent to-portfolio-highlight p-1 rounded-xl">
                    <div className="bg-portfolio-secondary p-6 rounded-lg">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs text-portfolio-neutral">KCPL Admin</span>
                      </div>
                      <div className="space-y-3">
                        <div className="bg-portfolio-accent/20 h-4 rounded"></div>
                        <div className="bg-portfolio-highlight/20 h-4 rounded w-3/4"></div>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="bg-portfolio-neutral/20 h-8 rounded"></div>
                          <div className="bg-portfolio-neutral/20 h-8 rounded"></div>
                        </div>
                        <div className="bg-portfolio-accent/10 h-12 rounded flex items-center justify-center">
                          <i className="fas fa-chart-pie text-portfolio-accent text-xl"></i>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="flex space-x-4">
                    <Button className="bg-portfolio-accent hover:bg-blue-600 text-white">
                      <i className="fas fa-external-link-alt mr-2"></i>
                      Live Demo
                    </Button>
                    <Button variant="outline" className="border-portfolio-accent text-portfolio-accent hover:bg-portfolio-accent">
